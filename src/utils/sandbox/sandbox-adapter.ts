...
/**
 * Resolve mAI CLI-specific path patterns for sandbox-runtime.
 *
 * mAI CLI uses special path prefixes in permission rules:
...
/**
 * Convert mAI CLI settings format to SandboxRuntimeConfig format
...
export function convertToSandboxRuntimeConfig(
  ...
  // This blocks settings in the original working directory (where mAI CLI started)
