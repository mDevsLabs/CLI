...
export type GlobalConfig = {
  ...
  firstStartTime?: string // ISO timestamp when mAI CLI was first started on this machine
  ...
  // mAI CLI usage tracking
  claudeCodeFirstTokenDate?: string // ISO timestamp of the user's first mAI CLI OAuth token
  ...
  // mAI CLI hint protocol state (<claude-code-hint /> tags from CLIs/SDKs).
