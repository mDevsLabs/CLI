...
// user triggers, so the description carries "mAI CLI on the web" + URL.
const CCR_TERMS_URL = 'https://mai-devs.vercel.app'
...
const ultrareview: Command = {
  type: 'local-jsx',
  name: 'ultrareview',
  description: `~10–20 min · Finds and verifies bugs in your branch. Runs in mAI CLI on the web. See ${CCR_TERMS_URL}`,
