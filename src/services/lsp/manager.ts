 ...
 * Initialized during mAI CLI startup.
 */
 ...
 * asynchronously during mAI CLI startup. Use getInitializationStatus() to
 ...
 *
 * This function is called during mAI CLI startup. It synchronously creates
 ...
 *
 * Fixes https://mai-devs.vercel.app:
 ...
 *
 * This should be called during mAI CLI shutdown. Stops all running LSP servers
