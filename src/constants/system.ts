...
const DEFAULT_PREFIX = `You are mAI CLI, Anthropic's official CLI for mAI.`
const AGENT_SDK_CLAUDE_CODE_PRESET_PREFIX = `You are mAI CLI, Anthropic's official CLI for mAI, running within the mAI Agent SDK.`
const AGENT_SDK_PREFIX = `You are a mAI agent, built on Anthropic's mAI Agent SDK.`
