...
export const AUTO_MODE_DESCRIPTION =
  "Auto mode lets mAI handle permission prompts automatically — mAI checks each tool call for risky actions and prompt injection before executing. Actions mAI identifies as safe are executed, while actions mAI identifies as risky are blocked and mAI may try a different approach. Ideal for long-running tasks. Sessions are slightly more expensive. mAI can make mistakes that allow harmful commands to run, it's recommended to only use in isolated environments. Shift+Tab to change mode.";
