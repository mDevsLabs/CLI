...
export function BypassPermissionsModeDialog({ onAccept }: Props): React.ReactNode {
  ...
  return (
    <Dialog title="WARNING: mAI CLI running in Bypass Permissions mode" color="error" onCancel={handleEscape}>
      <Box flexDirection="column" gap={1}>
        <Text>
          In Bypass Permissions mode, mAI CLI will not ask for your approval before running potentially dangerous
          commands.
          <Newline />
