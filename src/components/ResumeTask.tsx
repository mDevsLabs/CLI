    ...
    return (
      <Box flexDirection="column" padding={1}>
        <Box flexDirection="row">
          <Spinner />
          <Text bold>Loading mAI CLI sessions…</Text>
        </Box>
        <Text dimColor>{retrying ? 'Retrying…' : 'Fetching your mAI CLI sessions…'}</Text>
      </Box>
    );
  }
    ...
    return (
      <Box flexDirection="column" padding={1}>
        <Text bold color="error">
          Error loading mAI CLI sessions
        </Text>
...
function renderErrorSpecificGuidance(errorType: LoadErrorType): React.ReactNode {
  switch (errorType) {
    ...
    case 'api':
      return (
        <Box marginY={1} flexDirection="column">
          <Text dimColor>Sorry, mAI encountered an error</Text>
        </Box>
      );
    ...
    case 'other':
      return (
        <Box marginY={1} flexDirection="row">
          <Text dimColor>Sorry, mAI CLI encountered an error</Text>
        </Box>
      );
  }
}
