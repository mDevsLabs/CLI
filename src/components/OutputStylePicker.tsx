...
const DEFAULT_OUTPUT_STYLE_DESCRIPTION = 'mAI completes coding tasks efficiently and provides concise responses';
  ...
  return (
    ...
    >
      <Box flexDirection="column" gap={1}>
        <Box marginTop={1}>
          <Text dimColor>This changes how mAI CLI communicates with you</Text>
        </Box>
        {isLoading ? (
