...
export const ThinkingAdaptiveSchema = lazySchema(() =>
  z
    ...
    .describe('mAI decides when and how much to think (Opus 4.6+).'),
)
...
export const ThinkingConfigSchema = lazySchema(() =>
  z
    ...
    .describe(
      "Controls mAI's thinking/reasoning behavior. When set, takes precedence over the deprecated maxThinkingTokens.",
    ),
)
  ...
  z
    .object({
      ...
      supportsAdaptiveThinking: z
        ...
        .optional()
        .describe(
          'Whether this model supports adaptive thinking (mAI decides when and how much to think)',
        ),
      supportsFastMode: z
        .boolean()
        .optional()
