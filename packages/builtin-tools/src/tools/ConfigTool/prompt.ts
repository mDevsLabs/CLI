...
export const DESCRIPTION = 'Get or set mAI CLI configuration settings.'
...
export function generatePrompt(): string {
  ...
  return `Get or set mAI CLI configuration settings.

  View or change mAI CLI settings. Use when the user requests configuration changes, asks about current settings, or when adjusting a setting would benefit them.
