      ...
      ? [
          ...
          } as Tool,
          {
            ...
            description:
              ...
              "Use this when the user says: 'open mAI CLI', 'start a Codex terminal', 'launch Gemini', etc.",
            inputSchema: {
              type: 'object' as const,
              properties: {
                agent: {
  ...
  return [
    {
      ...
      description:
        ...
        'On approval the main mAI window hides and a fullscreen tooltip overlay appears. ' +
      ...
      inputSchema: {
        ...
        properties: {
          ...
          reason: {
            type: 'string',
            description:
              'What you will be teaching. Shown in the approval dialog as "mAI wants to guide you through {reason}". Keep it short and task-focused.',
          },
        },
        required: ['apps', 'reason'],
      },
