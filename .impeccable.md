...
**Tone**: Anthropomorphic warmth meets terminal precision. The brand orange (mAI CLI's terra cotta) is the thread that ties everything together — it's the human element in a technical world.
...
**Color**:
- Primary: mAI CLI orange family (`#D77757` / terra cotta)
...
- mAI CLI Orange: `rgb(215,119,87)` / `#D77757`
- mAI CLI Blue: `rgb(87,105,247)` / `#5769F7`
...
### Logo
- mAI CLI text + orange play button icon
